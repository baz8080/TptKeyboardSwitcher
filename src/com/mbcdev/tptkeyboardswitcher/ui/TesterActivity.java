...
public class TesterActivity extends RoboActivity {
  ...
  private void handleCopy() {
    ...
    File extFile = new File(getExternalFilesDir(null), "uk4.kcm");
    String extFilePath = extFile.getAbsolutePath();
    
    CommandRunner.Builder builder = new CommandRunner.Builder();
    
    String assetPath = Build.DEVICE + File.separator + "test.txt";
    ...
    try {
      FileUtils.copyRaw(
          getAssets().openFd(assetPath), extFilePath);
